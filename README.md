...
　　合わせて、VSCodeで操作できるようにし、GitHubへの連携も設定。<br>
  　　<a href="Others/Linux/Linux.md"><img src="https://img.shields.io/badge/Linux-Memo-FCC624?style=for-the-badge&logo=linux&logoColor=black"></a><br><br>
２　仮想マシン（ＶＭ）環境の構築として、Oracle VM VirtualBoxを<br>
　　インストールし、Windows Server2025の仮想マシンを作成。<br>
  　　<a href="Others/VM/VM.md"><img src="https://img.shields.io/badge/VirtualBox-Memo-FCC624?style=for-the-badge&logo=virtualbox&logoColor=white"></a>
